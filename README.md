...
conda create -n elf python=3.8
conda activate elf

# pip install pytorch <pip 速度快>
...
# 使用visual studio code 指导安装 cmake >= 3.8, gcc >= 4.9 
# 使用vcpkg包管理器安装 `tbb`
# This is platform-dependent.

# Clone and build the repository:
mkdir ~/tutorial && cd ~/tutorial
gh repo clone liudengfeng/ELFFB
cd ELFFB/rts/
mkdir build && cd build
cmake .. -DPYTHON_EXECUTABLE=$HOME/anaconda3/envs/elf/bin/python -DCMAKE_TOOLCHAIN_FILE=$HOME/src/vcpkg/scripts/buildsystems/vcpkg.cmake
make
